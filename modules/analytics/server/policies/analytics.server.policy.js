...
exports.invokeRolesPolicies = function () {
  acl.allow([{
    roles: ['admin'],
    allows: [{
      resources: '/api/applications/:applicationId/analytics/devicesByPlatform',
      permissions: '*'
    }, {
      resources: '/api/applications/:applicationId/analytics/getAudiences',
      permissions: '*'
    }, {
      resources: '/api/applications/:applicationId/analytics/getAudienceCounts',
      permissions: '*'
    }, {
      resources: '/api/applications/:applicationId/analytics/events',
      permissions: '*'
    }]
  }, {
    roles: ['user'],
